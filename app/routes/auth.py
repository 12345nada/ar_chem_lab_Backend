...
from app.crud.user import (
    ...
    set_user_level, search_user_full_data,
)
...
from app.schemas.user import (
    ...
    UpdateLevelModel, UserDataResponse,
)
...
def get_user_level(current_user: User = Depends(get_current_user), db: Session = Depends(get_db)):
